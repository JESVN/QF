    ...
    public class ETFXProjectileScript : MonoBehaviour
    {
        ...
        {	
            ...
            if (Physics.SphereCast(transform.position, radius, direction, out hit, detectionDistance)) // Checks if collision will happen
            {
                ...
                GameObject impactP = Instantiate(impactParticle, transform.position, Quaternion.FromToRotation(Vector3.up, hit.normal)); // Spawns impact effect
                ...
                //PlayerControls.Instance.AttackHand(transform.position);
